...
* Monitorice las acciones o las secuencias de acciones del sitio del que desee hacer un seguimiento, lo que le proporcionará información valiosa sobre el comportamiento del usuario y le permitirá optimizar la experiencia del usuario en función de sus acciones.
