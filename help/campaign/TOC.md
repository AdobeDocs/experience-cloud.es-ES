...
+ Sistema de informes dinámicos {#reporting}
   ...
   + Acerca del sistema de informes {#about-reporting}
      ...
      + [Solución de problemas](reporting/troubleshooting.md)
   + Lista de informes {#list-of-reports}
      ...
      + [Rechazos y correos que no se pueden entregar](reporting/non-deliverables-and-bounces.md)
   ...
   + Personalización de informes {#customizing-reports}
      ...
      + [Acuerdo de uso del sistema de informes dinámicos](reporting/pii-agreement.md)
+ Promoción de la marca {#branding}
   + [Acerca de la promoción de la marca](branding/branding-gs.md)
...
+ API de REST {#apis}
   ...
   + [Recomendaciones y limitaciones](api/limitations.md)
