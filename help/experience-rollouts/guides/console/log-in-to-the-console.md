...
Para empezar a usar los despliegues de experiencias, hay que seguir tres pasos: buscar o crear su equipo, solicitar acceso e iniciar sesión en la consola.
...
## Inicie sesión en la consola de {#log-in-steps}
