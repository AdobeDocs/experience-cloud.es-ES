...
* Una **clave de API** y un **token de servicio** ID de cliente de su proyecto de Adobe Developer Console; consulte [Suscribirse a la aplicación de API](../../integrate/subscribe-to-api-application.md)
