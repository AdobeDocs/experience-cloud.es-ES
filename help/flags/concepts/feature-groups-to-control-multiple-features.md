...
description: Descubra cómo los grupos de funciones en Banderas le permiten agrupar y administrar las marcas de funciones relacionadas en todas las aplicaciones como una sola unidad.
hide: true
