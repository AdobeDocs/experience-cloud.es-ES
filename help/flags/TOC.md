...
+ Primeros pasos {#get-started}
   + [Introducción a las marcas](getting-started/introduction.md)
   + [Razones para utilizar los indicadores](getting-started/why-use-flags.md)
   + [Modos de indicadores](getting-started/flags-modes.md)
+ Conceptos {#concepts}
...
+ Integrar indicadores {#integrate}
   + [Integración de indicadores en la aplicación](guides/integrate/integrating-in-your-app.md)
